...
| -------------------- | -------------- | -------------- | -------------- | ------------------------------- |
| `text-ui-title-lg`   | 32px (2rem)    | 40px (2.5rem)  | 600 (semibold) | Main page headings, hero titles |
| `text-ui-title-base` | 24px (1.5rem)  | 32px (2rem)    | 600 (semibold) | Section headings, card titles   |
| `text-ui-title-sm`   | 20px (1.25rem) | 28px (1.75rem) | 600 (semibold) | Subsection headings             |
...
| Class              | Size           | Line Height    | Font Weight  | Usage                             |
| ------------------ | -------------- | -------------- | ------------ | --------------------------------- |
| `text-ui-subtitle` | 20px (1.25rem) | 28px (1.75rem) | 500 (medium) | Subtitle text, emphasized content |
...
| Class               | Size            | Line Height    | Font Weight  | Usage                          |
| ------------------- | --------------- | -------------- | ------------ | ------------------------------ |
| `text-ui-body-lg`   | 18px (1.125rem) | 28px (1.75rem) | 400 (normal) | Large body text, introductions |
| `text-ui-body-base` | 16px (1rem)     | 24px (1.5rem)  | 400 (normal) | Default body text, paragraphs  |
| `text-ui-body-sm`   | 14px (0.875rem) | 20px (1.25rem) | 400 (normal) | Small body text, captions      |
...
| Class                | Size            | Line Height    | Font Weight  | Usage                     |
| -------------------- | --------------- | -------------- | ------------ | ------------------------- |
| `text-ui-label-lg`   | 16px (1rem)     | 24px (1.5rem)  | 500 (medium) | Large labels, form labels |
| `text-ui-label-base` | 14px (0.875rem) | 20px (1.25rem) | 500 (medium) | Default labels, buttons   |
| `text-ui-label-sm`   | 12px (0.75rem)  | 16px (1rem)    | 500 (medium) | Small labels, metadata    |
...
```html
<!-- Page hierarchy -->
<h1 class="text-ui-title-lg text-text-pr">Main Page Title</h1>

<div class="text-ui-subtitle text-text-sec">
    Supporting subtitle or description
</div>

<h2 class="text-ui-title-base text-text-pr">Section Heading</h2>

<p class="text-ui-body-base text-text-pr">
...
<h3 class="text-ui-title-sm text-text-pr">Subsection Heading</h3>

<p class="text-ui-body-sm text-text-sec">
...
-   **Titles** (`text-ui-title-*`): `font-weight: 600` (semibold)
-   **Subtitles** (`text-ui-subtitle`): `font-weight: 500` (medium)
-   **Body text** (`text-ui-body-*`): `font-weight: 400` (normal)
-   **Labels** (`text-ui-label-*`): `font-weight: 500` (medium)

```html
<!-- ✅ Good - font weight is already included -->
<h1 class="text-ui-title-lg">Perfect heading</h1>
<p class="text-ui-body-base">Perfect body text</p>
<label class="text-ui-label-base">Perfect label</label>

<!-- ❌ Unnecessary - font weight is already set -->
<h1 class="text-ui-title-lg font-semibold">Redundant weight</h1>

<!-- ✅ Override when needed -->
<h1 class="text-ui-title-lg font-bold">Custom bold heading</h1>
```
...
<h1 class="text-ui-title-base md:text-ui-title-lg">Responsive Heading</h1>

<!-- Responsive body text -->
<p class="text-ui-body-sm md:text-ui-body-base">
...
<h1 class="text-ui-title-lg text-text-pr">High contrast heading</h1>
<p class="text-ui-body-base text-text-sec">Medium contrast body</p>
<span class="text-ui-label-sm text-text-ter">Lower contrast metadata</span>
```
...
```html
<button
    class="text-ui-label-base focus:outline-none focus:ring-2 focus:ring-ring-inp-focus"
>
    Accessible Button
</button>
```
...
```html
<h1 class="text-ui-title-lg text-text-pr mb-4 max-w-3xl">
